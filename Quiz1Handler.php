...
<html>
    ...
    <body>
        ...
        <?php
            ...
            // create INSERT query
            $sql="INSERT INTO quiz1submissions (UserName, 
                                                SubmitDate, 
                                                quiz1q1, 
                                                quiz1q2, 
                                                quiz1q3, 
            ...
            try {
                ...
                $stmt = $conn->prepare("SELECT * FROM quiz1answers");
                $stmt->execute();
                ...
                for ($x = 1; $x <= count($answers); $x++) {
                    ...
                    if($answers["quiz1answer" . $x] === $_POST["quiz1q" . $x])
                    {
                        $numCorrect++;
                    }
                ...
                for ($x = 1; $x <= count($answers); $x++) {
                    ...
                    echo "<p class=\"showAnswer\">You answered " . $answers["quiz1answer" . $x] . " and the correct answer was " . $_POST["quiz1q" . $x] .  "</p>"; 
